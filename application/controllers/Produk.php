...
class Produk extends CI_Controller {
	...
	{	
		...
		$config['first_tag_close'] 	= '</liv>';
		$config['last_link'] 		= 'Last';
		$config['last_tag_open'] 	= '<li class="disabled"><li clas="active"><a href="">';
		...
		$config['firs_ulr']			= base_url(). '/produk/';
	...
	{	
		...
		$config['cur_tag_open'] 	= '<b>';
		$config['cur_tag_close'] 	= '</b>';
		$config['firs_ulr']			= base_url(). '/produk/kategori/' .$slug_kategori;
